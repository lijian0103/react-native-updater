...
public class AppUpdateUtils {
    ...
    public static String getApkName(UpdateAppBean updateAppBean) {
        String apkUrl = updateAppBean.getUpdateUrl();
    ...
    public static Intent getInstallAppIntent(Context context, File appFile) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri fileUri = FileProvider.getUriForFile(context, getAuthority(context), appFile);
    ...
    private static String getAuthority(Context context) {
        return  "updater." + context.getApplicationContext().getPackageName() + ".fileProvider";
    }
