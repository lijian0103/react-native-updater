package cn.cnlee.commons.updater.service;
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private void startDownload(UpdateAppBean updateApp, DownloadCallback callback) {
        ...
        updateApp.getDownloadManager().download(apkUrl, target, appName, new FileDownloadCallBack(callback));
    }
    ...
    class FileDownloadCallBack implements IDownloadManager.FileCallback {
